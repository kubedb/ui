...
$ helm repo update
$ helm search repo appscode/mongo-ui --version=v2026.3.30
$ helm upgrade -i mongo-ui appscode/mongo-ui -n demo --create-namespace --version=v2026.3.30
```
...
```bash
$ helm upgrade -i mongo-ui appscode/mongo-ui -n demo --create-namespace --version=v2026.3.30 --set image.tag=latest
```
...
```bash
$ helm upgrade -i mongo-ui appscode/mongo-ui -n demo --create-namespace --version=v2026.3.30 --values values.yaml
```
