...
$ helm repo update
$ helm search repo appscode/pgadmin --version=v2026.3.30
$ helm upgrade -i pgadmin appscode/pgadmin -n demo --create-namespace --version=v2026.3.30
```
...
| image.tag                      | Overrides the image tag whose default is the chart appVersion.                                                         | <code>"9.11.0"</code>                                                                                                                             |
...
```bash
$ helm upgrade -i pgadmin appscode/pgadmin -n demo --create-namespace --version=v2026.3.30 --set image.tag=latest
```
...
```bash
$ helm upgrade -i pgadmin appscode/pgadmin -n demo --create-namespace --version=v2026.3.30 --values values.yaml
```
