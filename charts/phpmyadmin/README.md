...
$ helm repo update
$ helm search repo appscode/phpmyadmin --version=v2026.3.30
$ helm upgrade -i phpmyadmin appscode/phpmyadmin -n demo --create-namespace --version=v2026.3.30
```
...
| image.tag                      | Overrides the image tag whose default is the chart appVersion.                                                         | <code>"5.2.3"</code>                                                                                                                                                                           |
...
```bash
$ helm upgrade -i phpmyadmin appscode/phpmyadmin -n demo --create-namespace --version=v2026.3.30 --set image.tag=latest
```
...
```bash
$ helm upgrade -i phpmyadmin appscode/phpmyadmin -n demo --create-namespace --version=v2026.3.30 --values values.yaml
```
